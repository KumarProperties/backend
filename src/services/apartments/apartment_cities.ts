...
import { City, CityModel, CitySchema } from '../../schema/apartments/cities';
import { MongooseError } from '../../validators/mongoose_validator';
import { getApartments } from './apartment';
